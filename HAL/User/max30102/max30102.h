...
float max30102_evaluateSignalQuality(float *input_data, uint16_t cache_nums);
uint8_t max30102_detectMotion(float *ir_data, float *red_data, uint16_t cache_nums);
#endif /* __MAX30102_H */
